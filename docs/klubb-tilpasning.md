...
|---|---|---|---|
| `NEXT_PUBLIC_BASE_URL` | Auto: `VERCEL_URL`, ellers `https://<KLUBB_DOMENE>` i prod, ellers `http://localhost:3000` | Absolutte URL-er i push-/e-postvarsler, ICS-filer, GitHub-webhook-lenker | Sett til din prod-URL (eller sett `NEXT_PUBLIC_KLUBB_DOMENE`). På Vercel arves `VERCEL_URL` automatisk for preview-deploys. |
