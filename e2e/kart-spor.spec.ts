 ...
 *
 * Fram til #698 ble sporet klippet til ett punkt utenom arrangementer. Et
 * eksempel: en flytting hjemmefra til jobb der bildet flyttet seg uten å
 * legge igjen noe. Punktene lå i basen hele tiden; det var visningen som
 * skjulte dem.
 *
...
test.describe('posisjonsspor under pågående arrangement (#695)', () => {
  ...
  test('hele ruta tegnes mens arrangementet pågår', async ({ page }) => {
    ...
    // «Sporer {tittel}»-pilla er fjernet (#749, bevisst mindre støy
  ...
  // Markøren viste opprinnelig initialer. En brukertest viste at
  // «1R» ikke fortalte noe om hvem som sto der — et ansikt gjenkjennes raskere
  // enn to bokstaver når man vet hvem som er med.
  ...
  test('pling-knappen kvitterer synlig etter trykk', async ({ page }) => {
    ...
    // Kjernen i det som ble meldt først: knappen sto helt uendret etter
