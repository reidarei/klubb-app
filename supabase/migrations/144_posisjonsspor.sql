...
-- per mann som ble overskrevet, slik at det ikke fantes noe spor. Kravet er
-- det motsatte: hver innmeldte posisjon under et pågående arrangement
...
-- Tabellen har i praksis én rad (fra egen test), men å droppe den uten å
-- ta med verdien ville fått delingen til å forsvinne uforklarlig midt i
