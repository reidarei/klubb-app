  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
        {/* Veibeskrivelse i Google Maps (#708). Et medlem spurte om dette
            allerede da kartet var nytt — trengtes det en «gå til»-funksjon,
            eller måtte man uansett inn i Google Maps for å finne det selv?
