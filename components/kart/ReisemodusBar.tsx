...
/**
 * Barens høyde. Var avatarens diameter fram til #744, der Reidar ba om at
 * profilbildet skulle ut av reisemodus — nå er tittelen (display-font, 22px
 ...
 * TopHeader ville brukt («samme sted i begge moduser», Reidars avgjørelse).
 *
  ...
  return (
    <div
      ...
      style={{
        ...
        // (Reidars ønske om midtstilt overskrift, #744).
        display: 'flex',
        alignItems: 'center',
