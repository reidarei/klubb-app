...
describe('kart-deltakere (#725)', () => {
  const alleAktive = [
    { id: 'a', navn: 'Per', bilde_url: null, rolle: 'medlem' },
    { id: 'b', navn: 'Kalle', visningsnavn: 'Ola', bilde_url: null, rolle: 'medlem' },
    { id: 'c', navn: 'Kari', bilde_url: null, rolle: 'admin' },
  ]
  ...
  it('kandidat-navn foretrekker visningsnavn over navn', () => {
    ...
    expect(kandidater).toEqual([{ profilId: 'b', navn: 'Ola', bildeUrl: null, rolle: 'medlem' }])
  })
